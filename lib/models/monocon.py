...
from lib.models.attentive_norm import AttnBatchNorm2d
...
class MonoCon(nn.Module):
    def __init__(self, backbone='dla34', neck='DLAUp', num_class=3, downsample=4):
        ...
        self.heads = {'heatmap': num_class, 'offset_2d': 2, 'size_2d' :2, 'depth': 2, 'offset_3d': 2, 'size_3d':3, 'heading': 24, 'center2kpt_offset': 16, 'kpt_heatmap': 8, 'kpt_heatmap_offset': 2}
        self.extra_inference_head = ['center2kpt_offset', 'kpt_heatmap', 'kpt_heatmap_offset']
        ...
        for head in self.heads.keys():
            ...
            fc = nn.Sequential(
                nn.Conv2d(channels[self.first_level], 64, kernel_size=3, padding=1),
                #AttnBatchNorm2d(64, self.num_AN_affine, momentum=0.03, eps=0.001),
    ...
    def forward(self, input, flag='train'):
        ...
        for head in self.heads:
            if flag=='inference' and (head in extra_inference_head):
                continue
