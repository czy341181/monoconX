...
class Tester(object):
    ...
    def inference(self):
        ...
        self.save_results(results, output_dir=self.cfg['save_dir'] + '/outputs')
    ...
    def evaluate(self):
        self.dataloader.dataset.eval(results_dir=self.cfg['save_dir'] + '/outputs/data', logger=self.logger)
